...
и компиляция, то есть на сами 88 тестов уходит примерно 2 секунды против 2,9. Причина простая:
...
Тесты разложены по операциям, один класс — один сценарий. В Allure та же разбивка видна
через `@Story`: Create, Read, Update, Delete.
...
На текущем образе это 37 падений из 88 тестов, и каждое сводится к одному из одиннадцати
